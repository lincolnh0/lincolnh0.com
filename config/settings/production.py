...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["lincolnh0.com"])
...
DEFAULT_FROM_EMAIL = env(
    "DJANGO_DEFAULT_FROM_EMAIL", default="lincolnh0.com <noreply@lincolnh0.com>"
)
...
EMAIL_SUBJECT_PREFIX = env(
    ...
    default="[lincolnh0.com]",
)

# Set email to local console.
EMAIL_BACKEND = env(
